 ...
 */
public class ByYears extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.years, container, false);
        years = (EditText) v.findViewById(R.id.years);
        value = (Button) v.findViewById(R.id.value);
    ...
    private List<ListValue> getData() {
        double n = Double.parseDouble(years.getText().toString());
        lists = new ArrayList<>();
        for (int i = 1; i <= 60; i++) {
